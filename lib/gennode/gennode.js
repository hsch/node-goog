 ...
 */
nclosure.gennode.gennode.prototype.writeDummyDocObjects_ =
...
nclosure.gennode.gennode.prototype.processObject_ =
  ...
  new nclosure.gennode.processor(name, true, obj, this.allDocs_,
      this.allTypeData_, coreRequires, overrideOverview).process();
};
 ...
 *    contents.
 */
nclosure.gennode.gennode.prototype.parseDocContents_ =
  ...
  goog.array.forEach(classes, function(c, i) {
    ...
    className = className.replace('child_processes', 'child_process');
