...
node.util.print = function() {
  return node.util.core_.print.apply(node.util.core_, arguments);
};
...
node.util.puts = function() {
  return node.util.core_.puts.apply(node.util.core_, arguments);
};
...
node.util.debug = function(x) {
  return node.util.core_.debug.apply(node.util.core_, arguments);
};
...
node.util.error = function(x) {
  return node.util.core_.error.apply(node.util.core_, arguments);
};
...
node.util.inspect = function(obj, showHidden, depth, colors) {
  return node.util.core_.inspect.apply(node.util.core_, arguments);
};
...
node.util.p = function() {
  return node.util.core_.p.apply(node.util.core_, arguments);
};
...
node.util.log = function(msg) {
  return node.util.core_.log.apply(node.util.core_, arguments);
};
...
node.util.exec = function() {
  return node.util.core_.exec.apply(node.util.core_, arguments);
};
...
node.util.pump = function(readStream, writeStream, callback) {
  return node.util.core_.pump.apply(node.util.core_, arguments);
};
...
node.util.inherits = function(ctor, superCtor) {
  return node.util.core_.inherits.apply(node.util.core_, arguments);
};
