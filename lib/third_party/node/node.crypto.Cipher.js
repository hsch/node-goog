...
node.crypto.Cipher.prototype.DTRACE_NET_SERVER_CONNECTION = function() {
  return node.crypto.Cipher.core_.DTRACE_NET_SERVER_CONNECTION.apply(node.crypto.Cipher.core_, arguments);
};
...
node.crypto.Cipher.prototype.DTRACE_NET_STREAM_END = function() {
  return node.crypto.Cipher.core_.DTRACE_NET_STREAM_END.apply(node.crypto.Cipher.core_, arguments);
};
...
node.crypto.Cipher.prototype.DTRACE_HTTP_SERVER_REQUEST = function() {
  return node.crypto.Cipher.core_.DTRACE_HTTP_SERVER_REQUEST.apply(node.crypto.Cipher.core_, arguments);
};
...
node.crypto.Cipher.prototype.DTRACE_HTTP_SERVER_RESPONSE = function() {
  return node.crypto.Cipher.core_.DTRACE_HTTP_SERVER_RESPONSE.apply(node.crypto.Cipher.core_, arguments);
};
