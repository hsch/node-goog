...
node.crypto.createCredentials = function(options) {
  return node.crypto.core_.createCredentials.apply(node.crypto.core_, arguments);
};
...
node.crypto.createHash = function(hash) {
  return node.crypto.core_.createHash.apply(node.crypto.core_, arguments);
};
...
node.crypto.createHmac = function(hmac, key) {
  return node.crypto.core_.createHmac.apply(node.crypto.core_, arguments);
};
...
node.crypto.createCipher = function(cipher, key) {
  return node.crypto.core_.createCipher.apply(node.crypto.core_, arguments);
};
...
node.crypto.createCipheriv = function(cipher, key, iv) {
  return node.crypto.core_.createCipheriv.apply(node.crypto.core_, arguments);
};
...
node.crypto.createDecipher = function(cipher, key) {
  return node.crypto.core_.createDecipher.apply(node.crypto.core_, arguments);
};
...
node.crypto.createDecipheriv = function(cipher, key, iv) {
  return node.crypto.core_.createDecipheriv.apply(node.crypto.core_, arguments);
};
...
node.crypto.createSign = function(algorithm) {
  return node.crypto.core_.createSign.apply(node.crypto.core_, arguments);
};
...
node.crypto.createVerify = function(algorithm) {
  return node.crypto.core_.createVerify.apply(node.crypto.core_, arguments);
};
