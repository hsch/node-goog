...
node.crypto.Decipher.prototype.DTRACE_NET_SERVER_CONNECTION = function() {
  return node.crypto.Decipher.core_.DTRACE_NET_SERVER_CONNECTION.apply(node.crypto.Decipher.core_, arguments);
};
...
node.crypto.Decipher.prototype.DTRACE_NET_STREAM_END = function() {
  return node.crypto.Decipher.core_.DTRACE_NET_STREAM_END.apply(node.crypto.Decipher.core_, arguments);
};
...
node.crypto.Decipher.prototype.DTRACE_HTTP_SERVER_REQUEST = function() {
  return node.crypto.Decipher.core_.DTRACE_HTTP_SERVER_REQUEST.apply(node.crypto.Decipher.core_, arguments);
};
...
node.crypto.Decipher.prototype.DTRACE_HTTP_SERVER_RESPONSE = function() {
  return node.crypto.Decipher.core_.DTRACE_HTTP_SERVER_RESPONSE.apply(node.crypto.Decipher.core_, arguments);
};
