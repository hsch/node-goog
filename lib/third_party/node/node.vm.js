...
node.vm.createScript = function(code, ctx, name) {
  return node.vm.core_.createScript.apply(node.vm.core_, arguments);
};
...
node.vm.createContext = function() {
  return node.vm.core_.createContext.apply(node.vm.core_, arguments);
};
...
node.vm.runInContext = function() {
  return node.vm.core_.runInContext.apply(node.vm.core_, arguments);
};
...
node.vm.runInThisContext = function() {
  return node.vm.core_.runInThisContext.apply(node.vm.core_, arguments);
};
...
node.vm.runInNewContext = function() {
  return node.vm.core_.runInNewContext.apply(node.vm.core_, arguments);
};
