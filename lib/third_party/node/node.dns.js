...
node.dns.resolve = function(domain, type_, callback_) {
  return node.dns.core_.resolve.apply(node.dns.core_, arguments);
};
...
node.dns.getHostByName = function(domain, family, callback) {
  return node.dns.core_.getHostByName.apply(node.dns.core_, arguments);
};
...
node.dns.getHostByAddr = function(address, family, callback) {
  return node.dns.core_.getHostByAddr.apply(node.dns.core_, arguments);
};
...
node.dns.lookup = function(domain, family, callback) {
  return node.dns.core_.lookup.apply(node.dns.core_, arguments);
};
...
node.dns.resolve4 = function(domain, callback) {
  return node.dns.core_.resolve4.apply(node.dns.core_, arguments);
};
...
node.dns.resolve6 = function(domain, callback) {
  return node.dns.core_.resolve6.apply(node.dns.core_, arguments);
};
...
node.dns.resolveMx = function(domain, callback) {
  return node.dns.core_.resolveMx.apply(node.dns.core_, arguments);
};
...
node.dns.resolveTxt = function(domain, callback) {
  return node.dns.core_.resolveTxt.apply(node.dns.core_, arguments);
};
...
node.dns.resolveSrv = function(domain, callback) {
  return node.dns.core_.resolveSrv.apply(node.dns.core_, arguments);
};
...
node.dns.reverse = function(domain, callback) {
  return node.dns.core_.reverse.apply(node.dns.core_, arguments);
};
...
node.dns.resolveNs = function(domain, callback) {
  return node.dns.core_.resolveNs.apply(node.dns.core_, arguments);
};
...
node.dns.resolveCname = function(domain, callback) {
  return node.dns.core_.resolveCname.apply(node.dns.core_, arguments);
};
