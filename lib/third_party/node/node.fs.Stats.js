...
node.fs.Stats.prototype.DTRACE_NET_SERVER_CONNECTION = function() {
  return node.fs.Stats.core_.DTRACE_NET_SERVER_CONNECTION.apply(node.fs.Stats.core_, arguments);
};
...
node.fs.Stats.prototype.DTRACE_NET_STREAM_END = function() {
  return node.fs.Stats.core_.DTRACE_NET_STREAM_END.apply(node.fs.Stats.core_, arguments);
};
...
node.fs.Stats.prototype.DTRACE_HTTP_SERVER_REQUEST = function() {
  return node.fs.Stats.core_.DTRACE_HTTP_SERVER_REQUEST.apply(node.fs.Stats.core_, arguments);
};
...
node.fs.Stats.prototype.DTRACE_HTTP_SERVER_RESPONSE = function() {
  return node.fs.Stats.core_.DTRACE_HTTP_SERVER_RESPONSE.apply(node.fs.Stats.core_, arguments);
};
