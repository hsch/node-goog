...
node.process.EventEmitter.prototype.DTRACE_NET_SERVER_CONNECTION = function() {
  return node.process.EventEmitter.core_.DTRACE_NET_SERVER_CONNECTION.apply(node.process.EventEmitter.core_, arguments);
};
...
node.process.EventEmitter.prototype.DTRACE_NET_STREAM_END = function() {
  return node.process.EventEmitter.core_.DTRACE_NET_STREAM_END.apply(node.process.EventEmitter.core_, arguments);
};
...
node.process.EventEmitter.prototype.DTRACE_HTTP_SERVER_REQUEST = function() {
  return node.process.EventEmitter.core_.DTRACE_HTTP_SERVER_REQUEST.apply(node.process.EventEmitter.core_, arguments);
};
...
node.process.EventEmitter.prototype.DTRACE_HTTP_SERVER_RESPONSE = function() {
  return node.process.EventEmitter.core_.DTRACE_HTTP_SERVER_RESPONSE.apply(node.process.EventEmitter.core_, arguments);
};
