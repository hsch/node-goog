...
node.net.isIP = function() {
  return node.net.core_.isIP.apply(node.net.core_, arguments);
};
...
node.net.isIPv4 = function(input) {
  return node.net.core_.isIPv4.apply(node.net.core_, arguments);
};
...
node.net.isIPv6 = function(input) {
  return node.net.core_.isIPv6.apply(node.net.core_, arguments);
};
...
node.net.createConnection = function(port, host) {
  return node.net.core_.createConnection.apply(node.net.core_, arguments);
};
...
node.net.createServer = function() {
  return node.net.core_.createServer.apply(node.net.core_, arguments);
};
