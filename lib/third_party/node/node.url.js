...
node.url.parse = function(url, parseQueryString, slashesDenoteHost) {
  return node.url.core_.parse.apply(node.url.core_, arguments);
};
...
node.url.resolve = function(source, relative) {
  return node.url.core_.resolve.apply(node.url.core_, arguments);
};
...
node.url.resolveObject = function(source, relative) {
  return node.url.core_.resolveObject.apply(node.url.core_, arguments);
};
...
node.url.format = function(obj) {
  return node.url.core_.format.apply(node.url.core_, arguments);
};
