...
node.process.compile = function() {
  return node.process.core_.compile.apply(node.process.core_, arguments);
};
...
node.process.reallyExit = function() {
  return node.process.core_.reallyExit.apply(node.process.core_, arguments);
};
...
node.process.chdir = function() {
  return node.process.core_.chdir.apply(node.process.core_, arguments);
};
...
node.process.cwd = function() {
  return node.process.core_.cwd.apply(node.process.core_, arguments);
};
...
node.process.getuid = function() {
  return node.process.core_.getuid.apply(node.process.core_, arguments);
};
...
node.process.setuid = function() {
  return node.process.core_.setuid.apply(node.process.core_, arguments);
};
...
node.process.setgid = function() {
  return node.process.core_.setgid.apply(node.process.core_, arguments);
};
...
node.process.getgid = function() {
  return node.process.core_.getgid.apply(node.process.core_, arguments);
};
...
node.process.umask = function() {
  return node.process.core_.umask.apply(node.process.core_, arguments);
};
...
node.process.dlopen = function() {
  return node.process.core_.dlopen.apply(node.process.core_, arguments);
};
...
node.process.memoryUsage = function() {
  return node.process.core_.memoryUsage.apply(node.process.core_, arguments);
};
...
node.process.binding = function() {
  return node.process.core_.binding.apply(node.process.core_, arguments);
};
...
node.process.assert = function() {
  return node.process.core_.assert.apply(node.process.core_, arguments);
};
...
node.process.nextTick = function(callback) {
  return node.process.core_.nextTick.apply(node.process.core_, arguments);
};
...
node.process.openStdin = function() {
  return node.process.core_.openStdin.apply(node.process.core_, arguments);
};
...
node.process.exit = function(code) {
  return node.process.core_.exit.apply(node.process.core_, arguments);
};
...
node.process.kill = function(pid, sig) {
  return node.process.core_.kill.apply(node.process.core_, arguments);
};
...
node.process.addListener = function(type, listener) {
  return node.process.core_.addListener.apply(node.process.core_, arguments);
};
...
node.process.on = function(type, listener) {
  return node.process.core_.on.apply(node.process.core_, arguments);
};
...
node.process.removeListener = function(type, listener) {
  return node.process.core_.removeListener.apply(node.process.core_, arguments);
};
...
node.process.debug = function() {
  return node.process.core_.debug.apply(node.process.core_, arguments);
};
...
node.process.error = function() {
  return node.process.core_.error.apply(node.process.core_, arguments);
};
...
node.process.watchFile = function() {
  return node.process.core_.watchFile.apply(node.process.core_, arguments);
};
...
node.process.unwatchFile = function() {
  return node.process.core_.unwatchFile.apply(node.process.core_, arguments);
};
...
node.process.mixin = function() {
  return node.process.core_.mixin.apply(node.process.core_, arguments);
};
...
node.process.createChildProcess = function() {
  return node.process.core_.createChildProcess.apply(node.process.core_, arguments);
};
...
node.process.inherits = function() {
  return node.process.core_.inherits.apply(node.process.core_, arguments);
};
...
node.process.setMaxListeners = function(n) {
  return node.process.core_.setMaxListeners.apply(node.process.core_, arguments);
};
...
node.process.emit = function(type) {
  return node.process.core_.emit.apply(node.process.core_, arguments);
};
...
node.process.once = function(type, listener) {
  return node.process.core_.once.apply(node.process.core_, arguments);
};
...
node.process.removeAllListeners = function(type) {
  return node.process.core_.removeAllListeners.apply(node.process.core_, arguments);
};
...
node.process.listeners = function(type) {
  return node.process.core_.listeners.apply(node.process.core_, arguments);
};
