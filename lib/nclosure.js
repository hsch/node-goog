 ...
 *
 * For instructions on using the nclosure project please read the README.md
 *    file.
 *
 ...
 * - nclosure_nclosurebase
 * - nclosure_settingsLoader
 * - nclosure_opts
...
goog.provide('nclosure');

goog.require('goog.Timer');
goog.require('goog.string');
goog.require('nclosure_nclosurebase');
...
nclosure = function() {
   ...
   */
  this.settingsLoader_ = /** @type {nclosure_settingsLoader} */
 ...
 */
nclosure.prototype.getPath = function(dir, file) {
 ...
 */
nclosure.prototype.getFileDirectory = function(file) {
  return this.settingsLoader_.getFileDirectory(file);
};


/**
 * @param {nclosure_opts=} opts Parameters object.
 * @return {nclosure} This instance of this class, for fluency.
 */
nclosure.prototype.init = function(opts) {
 ...
 *    specified file.
 */
nclosure.prototype.parseCompilerArgsFromFile = function(file) {
 ...
 */
nclosure.prototype.loadDependenciesFile = function(dir, file) {
 ...
 * @param {string} file  The file to execute and intercept the goog()  call.
 */
nclosure.prototype.loadAditionalDependenciesInSettingsFile = function(file) {
 ...
 * @param {nclosure_opts} opts The options describing any additional deps.
 */
nclosure.prototype.loadAditionalDependenciesInSettings_ = function(opts) {
 ...
 */
nclosure.prototype.setCurrentContext = function(ctx) { this.ctx_ = ctx; };
...
var ng_instance_ = new nclosure();


/**
 * Node.js module for nclosure.
 * @type {function(nclosure_opts):nclosure}
 */
