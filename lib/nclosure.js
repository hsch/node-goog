...
nclosure = function() {
   ...
   * 'nclosure' context.  This allows anyone (especially googtest) to
   * load any additional dependencies if required
   * @type {nclosure}
   */
  nclosure.instance = this;
};
 ...
 * @private
 */
nclosure.prototype.setNamespaceIn_ = function(target, value, namespace) {
