 ...
 */
node_goog_settingsLoader.prototype.getFileDirectory = function(file) {
 ...
 */
node_goog_settingsLoader.prototype.removeShebang = function(source) {
 ...
 * @param {node_goog_opts?} newData The data to add or replace in the
 *    target object.
 ...
 */
node_goog_settingsLoader.prototype.validateOpsObject_ =
 ...
 */
node_goog_settingsLoader.prototype.validateDir_ =
