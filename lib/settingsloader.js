 ...
 * in nclosure project.  The files using this include googdoc.js,
...
if (typeof(goog) !== 'undefined') {
  goog.provide('nclosure_opts');
  goog.provide('nclosure_settingsLoader');
}
 ...
 * @constructor
 */
var nclosure_settingsLoader = function() {
  /**
   * @private
   * @type {nclosure_opts}
   */
 ...
 */
nclosure_settingsLoader.prototype.getPath = function(baseDir, file) {
 ...
 */
nclosure_settingsLoader.prototype.getFileDirectory = function(file) {
 ...
 */
nclosure_settingsLoader.prototype.removeShebang = function(source) {
 ...
 *  call.
 * @return {nclosure_opts?} The options object represented in the
 *    specified file.
 */
nclosure_settingsLoader.prototype.parseCompilerArgsFromFile = function(file) {
 ...
 *   settings.
 *
 * @return {nclosure_opts?} The settings object.
 */
nclosure_settingsLoader.prototype.readArgsFromJSONFile = function(path) {
 ...
 *
 * @param {nclosure_opts=} opts The base options object to use.  This is
 *     used by goog.js and it passes in the init(opts) object.
 * @return {nclosure_opts} The options object in the current context.
 */
nclosure_settingsLoader.prototype.readSettingsObject = function(opts) {
  ...
  var settings = globalSettings || /** @type {!nclosure_opts} */ ({});
...
/**
 * @private
 * @param {nclosure_opts} target The object to extend.
 * @param {nclosure_opts?} newData The data to add or replace in the
 *    target object.
 * @return {nclosure_opts} The modified target object.
 */
nclosure_settingsLoader.prototype.extendObject_ = function(target, newData) {
 ...
 */
nclosure_settingsLoader.prototype.arrayContains_ = function(arr, o) {
 ...
 */
nclosure_settingsLoader.prototype.parseCompilerArgsFromFileImpl_ =
    function(file, code) {
  var opts;
  var ctx = {
 ...
 * @return {nclosure_opts} The options object.
 */
nclosure_settingsLoader.prototype.getOptsObject_ = function(dir, json) {
 ...
 *    executing javascript file.
 * @param {!nclosure_opts} opts The options object to validate.
 * @param {boolean} allowNullMandatories Wether to allow null mandatory
 *    directories.
 * @return {!nclosure_opts} The validated options object.
 */
nclosure_settingsLoader.prototype.validateOpsObject_ =
 ...
 */
nclosure_settingsLoader.prototype.parseClosureBasePath_ = function(dir) {
 ...
 */
nclosure_settingsLoader.prototype.validateDir_ =
 ...
 */
nclosure_settingsLoader.prototype.checkDirExists_ = function(dir) {
 ...
 */
exports.settingsLoader = new nclosure_settingsLoader();
