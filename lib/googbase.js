...
/**
  ...
  */
node_goog_googbase.prototype.closureScriptLoading = function(dir, file) {
  return true;
};
...
/**
  * @param {node_goog_opts} opts The settings object passed in to goog()
 ...
 */
node_goog_googbase.prototype.interceptGoogRequires_ = function() {
  ...
  goog.require = function intercept(namespace) {
    ...
    // already initialised
    if (namespace === 'node_goog_settingsLoader') { return { goog: that }; }
