 ...
 */
NodeGoog.closureUtils_ = require('../bin/utils').closureUtils;
...
NodeGoog.prototype.loadDependenciesFile = function(dir, file) {
  if (!NodeGoog.path_.existsSync(dir + file)) { return; }  
  this.loadScript_( dir, file);      
};
...
NodeGoog.prototype.loadAdditionalSettingsFile = function(dir) {
  var settings = NodeGoog.closureUtils_.readArgsFromJSONFile(dir + 'closure.json');
