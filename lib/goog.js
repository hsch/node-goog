...
node.goog.prototype.init = function(opts) {
  ...
  this.opts_ = opts || node.goog.closureUtils_.readSettingObject();
...
node.goog.prototype.loadAdditionalSettingsFile = function(dir) {
  var settings = /** @type {node.goog.opts} */ (node.goog.closureUtils_.readArgsFromJSONFile(
    node.goog.closureUtils_.getPath(dir, 'closure.json')));
...
node.goog.prototype.initialiseTestingFramework2_ = function() {
  if (typeof (goog.testing) !== 'undefined' &&
    ...
    goog.testing.TestCase.prototype.log = function(msg) {
      if (typeof(msg) === 'object' && msg.isJsUnitException &&
          this.nextStepName_) { // Only async tests
