 ...
 */
node.goog.prototype.getFileDirectory = function(file) {
 ...
 * @param {string} file  The file to execute and intercept the goog()  call
 */
node.goog.prototype.loadAditionalDependenciesInSettingsFile = function(file) {
...
var ng_instance_ = new node.goog();
exports.goog = goog.bind(ng_instance_.init, ng_instance_);