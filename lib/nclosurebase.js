...
if (typeof(goog) !== 'undefined') {
  goog.provide('nclosure_nclosurebase');
 ...
 * @constructor
 */
nclosure_nclosurebase = function() {
  /**
...
/**
  ...
  */
nclosure_nclosurebase.prototype.closureScriptLoading = function(dir, file) {
  return true;
};
...
/**
  ...
  * @param {string} file The file to load.
  */
nclosure_nclosurebase.prototype.closureScriptLoaded = function(dir, file) { };


/**
  * @param {nclosure_opts} opts The settings object passed in to goog()
  *    call which may contain some dependencies.
  */
nclosure_nclosurebase.prototype.loadAllDependencies = function(opts) {
 ...
 */
nclosure_nclosurebase.prototype.interceptGoogRequires_ = function() {
  ...
  goog.require = function intercept(namespace) {
    ...
    if (namespace === 'nclosure_settingsLoader') { return { goog: that }; }
...
/**
  ...
  * @private
  */
nclosure_nclosurebase.prototype.isRunningTestingFile_ = function() {
...
/**
  ...
  * @private
  */
nclosure_nclosurebase.prototype.runCurrentFileInGoogTest_ = function() {
...
/**
  ...
  * @private
  */
nclosure_nclosurebase.prototype.killCurrentThread_ = function() {
...
/**
  ...
  * @private
  */
nclosure_nclosurebase.prototype.loadBaseScript_ = function() {
...
/**
  ...
  * @private
  */
nclosure_nclosurebase.prototype.loadGoogDeps_ = function() {
...
/**
  ...
  * @private
  */
nclosure_nclosurebase.prototype.resolveClosureBasePath_ = function() {
...
/**
  ...
  * @private
  */
nclosure_nclosurebase.prototype.loadBaseScriptImpl_ = function() {
  this.loadScript(this.closureBasePath, 'base.js');
  goog.global = goog.window = global.window = global.top = global;
  var that = this;

  // Uglyness due to the fact that suppress {visibility} above is being ignored
  // in the compiler being used.  Not sure why.
...
/**
  ...
  * @param {string} file The file to load.
  */
nclosure_nclosurebase.prototype.loadScript = function(dir, file) {
...
/**
  ...
  */
nclosure_nclosurebase.prototype.loadDependenciesFile = function(dir, file) {
...
/**
  ...
  * @private
  */
nclosure_nclosurebase.prototype.loadCurrentScriptDeps_ = function() {
...
/**
  * @private
  * @param {nclosure_opts} opts The options object which we will parse for
  *    additional deps.
  */
nclosure_nclosurebase.prototype.loadAdditionalDepsInSettingsObject_ =
    function(opts) {
...
/**
 * @type {nclosure_nclosurebase}
 */
exports.nclosurebase = new nclosure_nclosurebase();
